  ...
  <el-container class="loginContainer">
              ...
              <div :class="{on:loginWay}">
                <el-form-item prop="phone">
                  ...
                  <button class="get_verification"
                          ...
                          @click.prevent="sendCode">{{computedTime>0?`已发送(${computedTime}s)`:`获取验证码`}}</button>
                </el-form-item>
    ...
    <el-footer class="login_footer">
      ...
      <div class="loginFooterB">
        <p>小米公司版权所有-京ICP备10046444-<span><img src="https://account.xiaomi.com/static/res/9204d06/account-static/respassport/acc-2014/img/ghs.png"
                 alt=""></span> 京公网安备11010802020134号-京ICP证110507号</p>
      </div>
    </el-footer>
  </el-container>
</template>
